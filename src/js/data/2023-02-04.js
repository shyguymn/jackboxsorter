dataSetVersion = "2023-02-04"; // Change this when creating a new data set version. YYYY-MM-DD format.
dataSet[dataSetVersion] = {};

dataSet[dataSetVersion].options = [
  {
    name: "Filter by Party Pack",
    key: "Packs",
    ...
    sub: [
      ...
      { name: "Pack 8", key: "pk8" },
      { name: "Pack 9", key: "pk9" },
      { name: "Drawful 2", key: "df2" },
      { name: "Fibbage EAY", key: "feay" },
      { name: "Quixort Forever", key: "qxfr" },
  },
  {
    name: "Exclude Prequels",
    key: "prq",
  }
];
